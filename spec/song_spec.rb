...
puts describe "Song" do
  ...
  puts describe "class variables" do
    it "has a class variable, @@count" do
      expect(Song.class_variable_get(:@@count)).to eq(3)
    end

    puts it "has a class variable, @@artists, that contains all of the artists of existing songs" do
